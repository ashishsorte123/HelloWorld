    ...
    render() {
        ...
        return (
            <View style={CardStyle}>
                ...
                <TouchableOpacity style={DownloadButtonStyle} onPress={() => { Alert.alert('Download Button Pressed!')}}>
                    <Text style={{color: 'white', fontWeight: 'bold', fontSize: 18}}>Download !!!</Text>
                </TouchableOpacity>
            </View>
        );
    }
